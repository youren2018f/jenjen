...
import openpyxl
wb = openpyxl.load_workbook(r"D:\Documents\Desktop\blank.xlsx")
#指定那一個worksheet
ws =wb['統計結果']
#開始疊代
i = 2 #從第幾列開始
for ind in df2.index:
    ...
    i = i + 1
wb.save("D:\Documents\Desktop\smaple01.xlsx")
